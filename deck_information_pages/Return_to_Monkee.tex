% ------------------------------------------------------------------------------------------------- %
% 				Return to Monkee - Kibo, Uktabi Prince		Marcel Zauder 26/03/2024				%
% Commander Deck Information Page                                                                   %
% ------------------------------------------------------------------------------------------------- %
% ################################################################################################# %
\newpage
\tocAddDeck{Return to Monkee}
% ------------------------------------------------------------------------------------------------- %
% ################################################################################################# %
% ---------------------------------------- Deck Information --------------------------------------- %
\DTLgetrowindex{\rowid}{CommanderDecks}{\dtlcolumnindex{CommanderDecks}{DeckName}}{Return to Monkee}
...
\renewcommand{\fancypagestyleheader}{Return to Monkee - General}
...
% Calculations
\calculateGeneralDeckStatistics{Return to Monkee}{LogBook1v1}{LogBook3Player}{LogBook4Player}%
...
\newpage
\renewcommand{\fancypagestyleheader}{Return to Monkee - 1v1}
...
% Calculations
\calculateGeneralDeckStatistics{Return to Monkee}{LogBook1v1}{}{}%
\calculateTurnNumberStatistics{Return to Monkee}{LogBook1v1}%
\calculateTwoPlayerSpecificDeckStatistics{Return to Monkee}{LogBook1v1}%
...
\newpage
\renewcommand{\fancypagestyleheader}{Return to Monkee - 3 Player}
...
% Calculations
\calculateGeneralDeckStatistics{Return to Monkee}{LogBook3Player}{}{}%
\calculateTurnNumberStatistics{Return to Monkee}{LogBook3Player}%
\calculateThreePlayerSpecificDeckStatistics{Return to Monkee}{LogBook3Player}%
...
\newpage
\renewcommand{\fancypagestyleheader}{Return to Monkee - 4 Player}
...
% Calculations
\calculateGeneralDeckStatistics{Return to Monkee}{LogBook4Player}{}{}%
\calculateTurnNumberStatistics{Return to Monkee}{LogBook4Player}%
\calculateFourPlayerSpecificDeckStatistics{Return to Monkee}{LogBook4Player}%
