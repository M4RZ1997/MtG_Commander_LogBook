...
\begin{document}
	...
	\newpage
	\renewcommand{\fancypagestyleheader}{Pre-Constructed Decks - General Statistic}
	\renewcommand{\fancypagestylesubheader}{}
	\tocAddDeck{Pre-Constructed Decks}
	
	\input{data/data_precon_1v1.tex}
	\input{data/data_precon_3player.tex}
	\input{data/data_precon_4player.tex}
	...
	% Win/Lose Statistic
	%\frameWinLoseStatistic{\winpercentage}{\losepercentage}
	\framePreConWinLoseStatistic
	
	% Color Match-Up OR Turn Number Statistic
	\calcMostLeastPreConColorIdentity{<}
	\framePreConColorCombinationAppearances
	
	% Side Frames
	\begin{tikzpicture}[remember picture,overlay]
		% Pre-Constructed Icon
		\node[xshift=767pt, yshift=-60pt] {%
			\includegraphics[width = 190pt, height = 200pt, keepaspectratio]{images/deck_crests/PreCon.png}%
		};%
		...
		\node[xshift=935pt, yshift=10pt, text width=136pt, anchor=north, inner sep=0pt, outer sep=0pt, white, align=center] {%
			\begin{tikzpicture}
				\node[text width=125pt] {%
					{\large 1v1 Commander}\\\vspace*{0.3em}\calcPerformanceStatistic{LogBookPreCon1v1}
				};%
				\node[yshift=-55pt, text width=125pt] {%
					{\large 3 Player Commander}\\\vspace*{0.3em}\calcPerformanceStatistic{LogBookPreCon3Player}
				};%
				\node[yshift=-110pt, text width=125pt] {%
					{\large 4 Player Commander}\\\vspace*{0.3em}\calcPerformanceStatistic{LogBookPreCon4Player}
				};%
			\end{tikzpicture}
		};%
		...
		\node[xshift=771.5pt, yshift=-277.5pt, text width=136pt, inner sep=0pt, outer sep=0pt, align=center] {%
			\includegraphics[width = 120pt, height = 120pt, keepaspectratio]{images/color_crests/\mlColorIdentity.png}%
		};
		\node[xshift=771.5pt, yshift=-340pt, text width=136pt, anchor=north, inner sep=0pt, outer sep=0pt, align=center] {%
			\color{white}The most played Color-Combination is\linebreak\mlColorIdentityName~(\mlColorIdentity)\linebreak(\mlTimesAppearanceNumber~Games played)\\
		};%
		...
		\node[xshift=935pt, yshift=-340pt, text width=136pt, anchor=north, inner sep=0pt, outer sep=0pt, align=center] {%
			\color{white}The least played Color-Combination is\linebreak\mlColorIdentityName~(\mlColorIdentity)\linebreak(\mlTimesAppearanceNumber~Games played)\\
		};%
		...
		\node[xshift=771.5pt, yshift=-442.5pt, text width=120pt, anchor=north, inner sep=0pt, outer sep=0pt, white] {%
			\printPreConDeckArchetypeDistribution%
		};
		
		% Author Notes
		\node[xshift=935pt, yshift=-420pt, text width=136pt, anchor=north, inner sep=0pt, outer sep=0pt, align=center] {%
			\color{white}{\large \textsc{Color-WIN Statistic}}%
		};%
		\node[xshift=935pt, yshift=-427.5pt, text width=130pt, anchor=north, inner sep=0pt, outer sep=0pt, white] {%
			\printPreConColorWinDistribution%
		};
	\end{tikzpicture}
	
	\newpage
	\renewcommand{\fancypagestyleheader}{1v1 Commander Breakdown (PreCon)}
	\xdef\logbook{LogBookPreCon1v1}
	...
	\newpage
	\renewcommand{\fancypagestyleheader}{3 Player Commander Breakdown (PreCon)}
	\xdef\logbook{LogBookPreCon3Player}
	...
	\newpage
	\renewcommand{\fancypagestyleheader}{4 Player Commander Breakdown (PreCon)}
	\xdef\logbook{LogBookPreCon4Player}
